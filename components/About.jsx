...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
        Hello! I&apos;m Garv, a passionate web developer and problem
          solver. Right now 
          I&apos;m pursuing B.Tech. degree in Computer Science and Engineering at
          Lovely Professional University in Punjab, India, with an expected
          graduation year of 2026. I&apos;m a software developer with experience
          in MERN and XAMPP stacks, and AI-driven solutions, all backed by a strong foundation in data structures, algorithms, and software development. I love tackling real-world problems through creative thinking and practical applications. My mission is simple: to leverage technology to build solutions that truly make a difference and support people around me.
          <br className="sm:block hidden" />
          Let&apos;s collaborate to bring your ideas to life!
        </div>
        <div className="w-fit break-words">
          <Link
            href="mailto:garvgaba.gg@gmail.com"
            target="_blank"
            rel="noreferrer"
