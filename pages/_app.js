...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Garv Gaba";
	const description =
		"Hello! I'm Garv Gaba, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
		"/assets/avatar.png";
	const url = "https://garv-gaba.netlify.app/";
